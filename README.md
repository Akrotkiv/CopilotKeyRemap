...
## Troubleshooting
- **Remap not working?** Try running the script as **Administrator**.  
- **Still not working?** Restart your computer after running the script.  
- **Key behaving strangely?** Remove the file from the Startup folder and restart.  
